...
# Run string tests
gcc -o test/build/test_pairdbstring test/test_pairdbstring.c test/unity/unity \
                                        src/pairdbstring.c
echo "---------- String Tests -----------" > test/test_output.txt
./test/build/test_pairdbstring >> test/test_output.txt

# Run parse tests
gcc -o test/build/test_parse test/test_parse.c test/unity/unity src/parse.c src/pairdbstring.c
...
gcc -o test/build/test_mem_hashtable test/test_mem_hashtable.c src/hashtable.c src/pairdbstring.c
