...
# Run parse tests
gcc -o test/test_parse test/test_parse.c test/unity/unity src/parse.c src/pairdbstring.c
...
gcc -o test/test_mem_hashtable test/test_mem_hashtable.c src/hashtable.c src/pairdbstring.c
